            ...
            children: [
                {
                    ...
                    componentProps: {
                        isNative: '2',
                        text: '<p style="text-align: center; line-height: 1;"><span style="font-size: 0.37333333333333335rem;">《原神用户个人信息及隐私保护政策》</span></p><p style="line-height: 1;"><span style="font-size: 0.37333333333333335rem;">（以下简称"《隐私政策》"）由您（以 下亦称"用户"或"您"）与上海米哈游影铁科技有限公司（下文亦称"米哈游"或 "我们"）共同缔结，本《隐私政策》具有合同效力。 欢迎您使用米哈游为您提供的服务，包括您与米哈游的交互行为及/或您注册 和使用米哈游游戏及/或注册和使用米哈游提供的产品或服务（以下统称"米哈 游服务"或"服务"）。</span></p><p style="line-height: 1;"><span style="color: #e03e2d; font-size: 0.37333333333333335rem;">为保障用户在使用米哈游服务期间的隐私权，米哈游特 此制定本《隐私政策》，用以向您说明在使用米哈游服务时，我们如何收集、 使用、储存和分享您的个人信息，以及我们为您提供的访问、更新、控制和保 护这些信息的方式。 本《隐私政策》适用于我们为您提供的米哈游的服务。当您使用我们提供的服 务时，我们将按照本《隐私政策》的约定处理和保护您的个人信息。 若您是未满 18 周岁的未成年人（特别是未满十四周岁的儿童），米哈游特别 提请您注意，您需要在您的监护人的陪同下阅读本《隐私政策》，我们已使 用加粗字体标注未成年人（特别是未满十四周岁的儿童）个人信息的相关的 条款，请您和您的监护人务必仔细阅读；请您在取得您的监护人对本《隐私 政策》全部条款的同意之后，使用米哈游服务。 儿童特别说明： 我们建议：任何儿童参加网上活动都应事先取得监护人的同意。</span></p><p style="line-height: 1;"><span style="color: #e03e2d; font-size: 0.37333333333333335rem;">如果您是不 满十四周岁的儿童，请通知您的监护人共同阅读本《隐私政策》，并在您提 交个人信息、使用米哈游服务之前，寻求并取得您的监护人的同意和指导。 您点击同意本《隐私政策》，或者您使用/继续使用米哈游服务、提交个人信 息，都表示您已获得您的监护人的许可，且您的监护人亦同意受本《隐私政 策》。 </span></p><p style="line-height: 1;"><span style="font-size: 0.37333333333333335rem;">我们可能会适时对本《隐私政策》进行修订。当本《隐私政策》的条款发生变 更时，我们会在版本更新时以页面提示、弹窗、网站公告等适当的方式向您提</span></p>'
                    }
                }
            ]
        }
